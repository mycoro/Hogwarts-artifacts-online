...
public class ArtifactControllerIntegrationTest {
    ...
    void setUp() throws Exception {
        ...
        this.token = "Bearer " + json.getJSONObject("data").getString("token"); //dont forget to add "bearer " as a prefix
    }
    ...
    void testAddArtifactSuccess() throws Exception {
        ...
        this.mockMvc.perform(get(this.baseUrl + "/artifacts").accept(MediaType.APPLICATION_JSON).header(HttpHeaders.AUTHORIZATION, token))
                .andExpect(jsonPath("$.flag").value(true))
                .andExpect(jsonPath("$.code").value(StatusCode.SUCCESS))
                .andExpect(jsonPath("$.message").value("Find All Success"))
